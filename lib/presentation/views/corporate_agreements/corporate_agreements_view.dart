    ...
    return Row(
      children: [
        ...
        Container(
          ...
          child: IconButton(icon: Icon(Icons.filter_list, color: Colors.grey[700]), onPressed: () {}),
        ),
      ],
    );
  }
      ...
      children: [
        ...
        Column(
          ...
          children: [
            ...
            Text(value, style: TextStyle(fontSize: 16, color: Colors.grey[800], fontWeight: FontWeight.w500)),
          ],
        ),
      ],
    );
