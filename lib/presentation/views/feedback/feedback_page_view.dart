  ...
  void _submitFeedback() {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Geri Bildirim Gönderildi!'), backgroundColor: AppColors.searcColor));
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text(
          "Gönder",
          style: TextStyle(color: AppColors.whiteSpot, fontSize: 16, fontWeight: FontWeight.w500),
        ),
      ),
    );
  }
